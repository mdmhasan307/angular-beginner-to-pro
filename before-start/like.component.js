...
You're going to implement this feature in Angular and for that you'll need to create a component. This component is a TypeScript class that encapsulates
the data for rendering the like button (eg: the number of likes, and whether the button is in the on/off state). It also responds to user actions. So, when
the user clicks the "Like" button, the number of likes should be increased and the button should be in the "selected/on" state. If the user clicks the button again,
...
Define this class in a separate module and use it in the main module. Simulate the scenario where the user clicks the like component. Display the total number of likes and whether the
...
var LikeComponent = /** @class */ (function () {
    function LikeComponent(_likesCount, _isSeleceted) {
        this._likesCount = _likesCount;
        this._isSeleceted = _isSeleceted;
    }
    ;
    LikeComponent.prototype.onClick = function () {
        ...
        // }
        this._likesCount += (this._isSeleceted) ? -1 : 1;
        this._isSeleceted = !this._isSeleceted;
    };
